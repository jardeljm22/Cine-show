...
const Filmes = ({ tipoDeBuscaFilme , nomeFilme='' ,pageFilme}) =>{ // sempre será retornado ou tipo de filme ou o nome do filme
    ...
    const {listaFilmes,totalPagesDaBusca,page,setPage} = useReturnFilmes({tipoDeBuscaFilme : tipoDeBuscaFilme,nomeFilme : nomeFilme,pageInicial : pageFilme})
        ...
        return (
            <article className="article-filmes"  >
                ...
                <div className="container-article-filmes" >
                    {   listaFilmes?.data?.data?.results?.map((filme)=>( 
